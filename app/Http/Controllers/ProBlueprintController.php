...
class ProBlueprintController extends Controller
{
    public function blueprint()
    {
        return Inertia::render('ProBlueprint');
    }
    ...
    public function start(Request $request)
    {
        ...
        session(['active_pro_blueprint' => $critique->unique_id]);

        return redirect()->route('blueprint.pro.show', $critique->unique_id);
    }
    ...
    public function showDetails($uniqueId)
    {
        ...
        return Inertia::render('ProBlueprintShow', [
            'critique' => $critique,
        ]);
    }
}
